		...
		try{
			$db->insert('xmessages', array(
     		...
     		if($mail_type === 'SMTP'){
				...
				var_dump($user->data()->email);
				var_dump($user->data()->firstname . $user->data()->lastname);
				...
				var_dump($userData->firstname . $userData->lastname);
